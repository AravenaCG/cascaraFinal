...
int dm_readAllAlquiler(ArrayList* pArrayAlquiler)
{
    ...
    if(pArchivoAlquiler!=NULL)
    {
        do{
            ...
            {
                pAlquiler=alquiler_new(auxAlquiler.id,auxAlquiler.idCliente,auxAlquiler.equipo,auxAlquiler.estado,auxAlquiler.tiempoEstimado,auxAlquiler.tiempoReal);
...
int dm_readAllClienteTexto(ArrayList* pArraySocios)
{
    /*FILE *pFile;
    Socio* pSocio;
    int maxId=0, retorno;
